    ...
    link: [
      ...
      },
      {
        ...
        setOpenKey: [
          ...
          "/ecommerce/productEcommerce/tiktok",
          "/ecommerce/productEcommerce/lazada",
          "/ecommerce/productEcommerce/tiki",
          "/ecommerce/orderEcommerce/shopee",
          "/ecommerce/orderEcommerce/tiktok",
          "/ecommerce/orderEcommerce/lazada",
          "/ecommerce/orderEcommerce/tiki",
        ],
        icon: "fas fa-th-large",
        open: "ecommerce",
        children: [
          {
            name: "Đồng bộ sàn TMĐT",
            ...
            children: [
              {
                ...
                name: "Shopee.vn",
                exact: true,
                to: "/ecommerce/productEcommerce/shopee",
              },
              {
                class: "ecommerce_products",
                display: "hide",
                name: "Tiktok.com",
                exact: true,
                to: "/ecommerce/productEcommerce/tiktok",
              },
              {
                class: "ecommerce_products",
                display: "hide",
                name: "Lazada.vn",
                exact: true,
                to: "/ecommerce/productEcommerce/lazada",
              },
              {
                class: "ecommerce_products",
                display: "hide",
                name: "Tiki.vn",
                exact: true,
                to: "/ecommerce/productEcommerce/tiki",
              },
            ],
          },
          {
            ...
            children: [
              {
                ...
                name: "Shopee.vn",
                exact: true,
                to: "/ecommerce/orderEcommerce/shopee",
              },
              {
                class: "ecommerce_orders",
                display: "hide",
                name: "Tiktok.com",
                exact: true,
                to: "/ecommerce/orderEcommerce/tiktok",
              },
              {
                class: "ecommerce_orders",
                display: "hide",
                name: "Lazada.vn",
                exact: true,
                to: "/ecommerce/orderEcommerce/lazada",
              },
              {
                class: "ecommerce_orders",
                display: "hide",
                name: "Tiki.vn",
                exact: true,
                to: "/ecommerce/orderEcommerce/tiki",
              },
            ],
          },
        ],
