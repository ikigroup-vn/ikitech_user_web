...
export const API_URL_DEV = "https://apibanhang.dongtienbakery.com/api";

// export const API_URL_DEV = "http://127.0.0.1:8000/api";
export const API_URL_MAIN = "https://apibanhang.dongtienbakery.com/api";
export const API_URL_SOCKET_DEV = "https://apibanhang.dongtienbakery.com:3333/";
export const API_URL_SOCKET_MAIN = "https://apibanhang.dongtienbakery.com:3333/";
