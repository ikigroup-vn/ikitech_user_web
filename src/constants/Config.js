...
export const API_URL_DEV = "https://main.miraimobile.ikitech.vn/api";
// export const API_URL_DEV = "http://127.0.0.1:8000/api";
export const API_URL_MAIN = "https://main.miraimobile.ikitech.vn/api";
export const API_URL_SOCKET_DEV = "https://main.miraimobile.ikitech.vn:6441/";
export const API_URL_SOCKET_MAIN = "https://main.miraimobile.ikitech.vn:6441/";
