              ...
              <div id="content">
                ...
                {typeof isShow == "undefined" ? <div></div> : isShow == true ?
                  ...
                  <div class="container-fluid">
                    ...
                    >
                      <h3 class="h3 title_content mb-2 text-gray-800">Voucher giảm giá</h3>
                      <div
                      >
                        <Link
                    ...
                    <div class="card shadow mb-4">
                      ...
                      <div class="card-body">
                        <Table update={update} _delete={_delete} is_end={is_end} handleIsEndCallback={this.handleIsEndCallback} handleDelCallBack={this.handleDelCallBack} params={params} vouchers={vouchers} />
                        <Pagination
                          display={displayPag}
                          params={params}
                          vouchers={vouchers}
