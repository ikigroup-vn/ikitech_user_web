...
class ModalUpdatePercentDiscountAll extends Component {
  constructor(props) {
    super(props);
    this.state = {
      commission_percent: "",
  ...
  onSave = () => {
    const { store_code, updateAgencyPercentDiscount, agency_type_id } =
      this.props;
...
export default connect(null, mapDispatchToProps)(ModalUpdatePercentDiscountAll);
