...
import Form from "../../components/Staff/Create/Form";
...
class Create extends Component {
  ...
  render() {
    ...
    var {history,decentralization} = this.props;
                    ...
                    <section class="content">
                      <div class="row">
                        <div class="col-md-12 col-xs-12">
                          ...
                          <div class="box">
                      <Form history = {history} decentralization = {decentralization}  store_code = {store_code}/>
                          </div>
                        </div>
                      </div>
                    </section>
