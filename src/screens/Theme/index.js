...
class Theme extends Component {
  ...
  componentDidUpdate(prevProps, prevState) {
    if (this.state.isLoading != true && typeof this.props.permission.product_list != "undefined") {
      ...
      var isShow = web_theme_overview == false && web_theme_contact == false && web_theme_help == false && web_theme_footer == false &&
       web_theme_banner == false ? false : true

      this.setState({ isLoading: true, web_theme_overview, web_theme_contact, web_theme_help, web_theme_footer, web_theme_banner , isShow })
  ...
  render() {
    var { store_code } = this.props.match.params;
    var { tabId, web_theme_overview, web_theme_contact, web_theme_help, web_theme_footer, web_theme_banner,isShow } = this.state;
            ...
            <div className="container-fluid">
              ...
              <div className="card shadow mb-4">
                <div className="card-body">
                  ...
                  >
                    <TabList>
                      {web_theme_overview == true ? <Tab>
                        <i class="fa fa-cogs"></i>
                        <span>Tổng quan</span>
                      </Tab> : null}
                      <Tab>
                        <i class="fa fa-home"></i>
                        <span>Màn hình trang chủ</span>
                      </Tab>
                      {web_theme_contact == true ? <Tab>
                        <i class="fas fa-address-book"></i>
                        <span>Liên hê</span>
                      </Tab> : null}

                      {web_theme_help == true ? <Tab>
                        <i class="fas fa-address-book"></i>
                        <span>Hỗ trợ</span>
                      </Tab> : null}

                      {web_theme_footer == true ? <Tab>
                    ...
                    {web_theme_overview == true ? <TabPanel>
                      <Overview
                        tabId={tabId}
                    ...
                    {web_theme_contact == true ?    <TabPanel>
                      <Contact
                        theme={theme}
                        tabId={tabId}
                        store_code={store_code}
                    ...
                    {web_theme_footer == true ? <TabPanel>
                      <FooterTheme
                        theme={theme}
                        tabId={tabId}
                        store_code={store_code}
