                ...
                {typeof isShow == "undefined" ? <div style={{ height: "500px" }}></div> :
                  isShow == true ?
                    ...
                    <div className="container-fluid">
                      ...
                      <div class="row">
                        <div className="col-lg-3 col-xl-3 col-md-12 col-sm-12" style={{ paddingBottom: "15px" }}>
                        ...
                        <div class="card shadow mb-4 col-lg-9 col-xl-9 col-md-12 col-sm-12" style={{ height: "100%" }}>
                          <div class="card-header py-3">
                            <h6 class="m-0 title_content font-weight-bold text-primary">
                              Tổng quan
                            </h6>
                      ...
                      <div class="" >
                        ...
                        <div class="card shadow mb-4 col-12" style={{ height: "100%" }}>
                          ...
                          <div class="card-body">
                            ...
                            <ChartSales badges={badges} store_code={store_code} overview={overview} />
                          </div>
                        </div>
