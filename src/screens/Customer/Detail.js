...
class Customer extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    this.setState({
      ...
      txtDateOfBirth: customer.date_of_birth != null && customer.date_of_birth != "" ? moment(customer.date_of_birth, "YYYY-MM-DD HH:mm:ss").format("DD-MM-YYYY") : null,
  ...
  render() {
    ...
    var txtIsCollaborator =
      txtIsCollaborator == null || txtIsCollaborator == ""
        ? "Không"
        : "Có";
    var txtSex = txtSex == 1 ? "Nam" : txtSex == 2 ? "Nữ" : "Khác"
    var address_default = ""
    if (typeof txtDefault_address === 'object' && txtDefault_address !== null) {
      if (txtDefault_address.address_detail !== null && txtDefault_address.address_detail !== "") {
        address_default = address_default + txtDefault_address.address_detail + ", "
      }
      if (txtDefault_address.wards_name !== null && txtDefault_address.wards_name !== "") {
        address_default = address_default + txtDefault_address.wards_name + ", "
      }
      if (txtDefault_address.district_name !== null && txtDefault_address.district_name !== "") {
        address_default = address_default + txtDefault_address.district_name + ", "
      }
      if (txtDefault_address.province_name !== null && txtDefault_address.province_name !== "") {
