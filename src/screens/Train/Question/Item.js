...
class CourseEdit extends Component {
  ...
  passEditFunc = (e, data) => {
    ...
    this.props.handleUpdateCallBack(data);
    e.preventDefault();
  };
  ...
  render() {
    ...
    return (
      <div
        className="wrap-box-item hover-product"
        style={{
      ...
      >
        <div className="" style={{ padding: "10px" }}>
          <div style={{ width: "100%" }}>
            ...
            {data.question_image != "" && data.question_image != null && (
              <img
                style={{ margin: "auto", width: "160px", height: "160px" }}
          ...
          <div className="answer">
            <div className="item-result">A. {data.answer_a}</div>
            <div className="item-result">B. {data.answer_b}</div>

            <div className="item-result">C. {data.answer_c}</div>

            <div className="item-result">D. {data.answer_d}</div>
        ...
        <div className="action-box">
          <button
            ...
            onClick={(e) => this.passEditFunc(e, JSON.stringify(data))}
            data-toggle="modal"
