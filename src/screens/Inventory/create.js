...
class CreateInventory extends Component {
    ...
    shouldComponentUpdate(nextProps, nextState) {
        var exist_branch = 0
        var reality_total = 0
        if(!shallowEqual(nextState.listInventory,this.state.listInventory)){
            nextState.listInventory.forEach((item) =>{
                exist_branch = exist_branch + item.stock
                reality_total = reality_total +1
            })
            this.setState({existing_branch:exist_branch,reality_exist_total:reality_total,deviant_total:this.state.existing_branch-this.state.reality_exist_total})
        }
        
        console.log("reality_exist_total",reality_total)
        return true
    }
    ...
    handleCallbackQuantity = (modal) =>{
        console.log("modal",modal)
        this.setState({reality_exist_total:this.state.reality_exist_total+1,deviant_total:this.state.existing_branch-this.state.reality_exist_total})
    }
                                    ...
                                    <div className='col-lg-4 col-xl-4 col-md-12 col-sm-12'>
                                        <div className='card shadow mb-4' style={{ height: "100%" }}>
                                            ...
                                            <div className='card-bodys' style={{ width: "0 10px", height: "380px", overflowY: "auto" }}>
                                                <ListInventorySheet store_code={store_code} listInventory={listInventory} handleCallbackQuantity={this.handleCallbackQuantity} />
                                            </div>
