...
class Bill extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      statusPayment: "",
      numPage: 20,
      agency_by_customer_id: queryString.parse(window.location.search).agency_by_customer_id || null,
    };
  }
  closeChatBox = (status) => {
    this.setState({
  ...
  componentDidMount() {
    ...
    if (this.props.customer.id !== this.state.agency_by_customer_id && this.state.agency_by_customer_id != null) {
    ...
    var params =
      typeof status_code == "undefined" ? null :
                    ...
                    <div className="container-fluid">
                      ...
                      >
                        <h4 className="h4 title_content mb-0 text-gray-800">
                          Đơn hàng {typeof customer.id != "undefined" && customer.id == this.state.agency_by_customer_id ? `của Đại lý ${customer.name}` : null}
                        </h4>{" "}
                      </div>
                          ...
                          <div class="row" style={{ "justify-content": "space-between" }}>
                            ...
                            <form onSubmit={this.searchData}>
                              ...
                              <p class="total-item" id="sale_user_name">
                                <span className="num-total_item" >{bills.total}&nbsp;</span><span className="text-total_item" id="user_name">hóa đơn</span> &nbsp;&nbsp;
