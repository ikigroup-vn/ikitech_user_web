...
export const fetchAllSteps = (store_code) => {
  return callApi(`/store/${store_code}/agency_configs/bonus_steps`, "get", null);
};
export const createStep = (store_code , data) => {
  return callApi(`/store/${store_code}/agency_configs/bonus_steps`, "post", data);
};

export const destroyStep = (store_code, id) =>{
  return callApi(`/store/${store_code}/agency_configs/bonus_steps/${id}`, "delete", null);
}

export const updateStep = (store_code,id ,data) =>{
  return callApi(`/store/${store_code}/agency_configs/bonus_steps/${id}`, "put", data);
}
...
export const fetchAllRequestPayment = (store_code) => {
  return callApi(`/store/${store_code}/agencies/request_payment/current`, "get", null);
};
export const fetchAllHistory = (store_code) => {
  return callApi(`/store/${store_code}/agencies/request_payment/history`, "get", null);
};
export const updateRequestPayment = (store_code,data) =>{
  return callApi(`/store/${store_code}/agencies/request_payment/change_status`, "post", data);
}

export const updateAllRequestPayment = (store_code) =>{
  return callApi(`/store/${store_code}/agencies/request_payment/settlement`, "post", null);
}
...
export const fetchAllTopReport = (store_code , page=1 , params) => {
  if(params != null)
  {
    return callApi(`/store/${store_code}/agencies/report?page=${page}${params}`, "get", null);

  }

  return callApi(`/store/${store_code}/agencies/report?page=${page}`, "get", null);
};
...
export const addBonusSteps = (store_code, data) =>{
  return callApi(`/store/${store_code}/bonus_agency_config/bonus_steps`, "post", data);
}

export const updateBonusSteps = (store_code,id, data) =>{
  return callApi(`/store/${store_code}/bonus_agency_config/bonus_steps/${id}`, "put", data);
}

export const deleteBonusSteps = (store_code,id) =>{
  return callApi(`/store/${store_code}/bonus_agency_config/bonus_steps/${id}`, "delete", null);
}