...
class Chart extends Component {
    ...
    componentDidMount() {
        ...
        var { collaborator_by_customer_id, store_code } = this.props;

        if (collaborator_by_customer_id != null) {
            console.log(collaborator_by_customer_id)
            this.props.fetchCustomerId(store_code, collaborator_by_customer_id);
        }
    ...
    onchangeDate = (value) => {
        ...
        //this.props.fetchOverview(store_code, `?date_from=${date.from}&date_to=${date.to}&collaborator_by_customer_id=${this.props.collaborator_by_customer_id}`)
    };
    ...
    onchangeDateFromTo = (e) => {
        ...
        var { store_code, collaborator_by_customer_id } = this.props;
        this.props.fetchOverview(store_code, `?date_from=${from}&date_to=${to}&collaborator_by_customer_id=${collaborator_by_customer_id}`);
    };
    fromPrime = () => {
        this.setState({
            typeChartShow: "PRIME"
    ...
    render() {
        ...
        var total_referral_of_customer_count =
            typeof overview.data_prime_time != "undefined"
                ? overview.data_prime_time.total_referral_of_customer_count
                : 0;
        var shareCollaborator =
            typeof overview.data_prime_time != "undefined"
                ? format(Number(overview.data_prime_time.share_collaborator))
                : 0;
        ...
        return (
            <div className="chart">
                <ModalPostDate collaborator_by_customer_id={this.props.collaborator_by_customer_id} reset={reset} handleGetDatePost={this.handleGetDatePost} store_code={store_code} typeDate={typeDate} />
            ...
            /> */}
                ...
                <div class="row">
                    <div class="col-xl-3 col-lg-3" onClick={() => { this.actionChart("total_final") }}>
                    ...
                    <div class="col-xl-3 col-lg-3" onClick={() => { this.actionChart("total_order_count") }}>
                        <div class="card card-stats mb-4 mb-xl-0">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col">
                    ...
                    <div class="col-xl-3 col-lg-3" onClick={() => { this.actionChart("total_referral_of_customer_count") }}>
                        <div class="card card-stats mb-4 mb-xl-0">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col">
                    ...
                    <div class="col-xl-3 col-lg-3" onClick={() => { this.actionChart("share_collaborator") }}>
                        <div class="card card-stats mb-4 mb-xl-0">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col">
