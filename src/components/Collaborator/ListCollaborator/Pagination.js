...
class Pagination extends Component {
  ...
  passPagination = (page) => {
    this.props.fetchAllCollaborator(this.props.store_code , page)    
}
...
const mapDispatchToProps = (dispatch, props) => {
  return {
    ...
    fetchAllCollaborator: (store_code , page) => {
      dispatch(collaboratorAction.fetchAllCollaborator(store_code , page));
    },
  };
};
