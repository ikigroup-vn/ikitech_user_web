...
class Form extends Component {
  ...
  setData(rewardPoints) {
    this.setState({
      ...
      bonus_point_bonus_product_to_agency: rewardPoints.bonus_point_bonus_product_to_agency,
      bonus_point_product_to_agency: rewardPoints.bonus_point_product_to_agency,
    })
  }

  componentWillReceiveProps(nextProps) {
    if (!shallowEqual(nextProps.rewardPoints, this.props.rewardPoints) || this.state.id == "") {
  ...
  onSave = (e) => {
    ...
    var { allow_use_point_order,
      ...
      point_review } = this.state
    var form = {
      allow_use_point_order,
      is_set_order_max_point, bonus_point_product_to_agency,
      bonus_point_bonus_product_to_agency,
      ...
      point_introduce_customer: point_introduce_customer == null ? point_introduce_customer : point_introduce_customer.toString().replace(/,/g, '').replace(/-/g, ''),
      point_review: point_review == null ? point_review : point_review.toString().replace(/,/g, '').replace(/-/g, ''),
      is_percent_use_max_point,
    }

    if (is_percent_use_max_point == false)
      form.percent_use_max_point = null
    else
      form.percent_use_max_point = percent_use_max_point == null ? percent_use_max_point : percent_use_max_point.toString().replace(/,/g, '').replace(/-/g, '')
  ...
  render() {
    var { allow_use_point_order,
      ...
      is_percent_use_max_point,
      percent_use_max_point,
      point_review, ex, bonus_point_product_to_agency, bonus_point_bonus_product_to_agency } = this.state
    ...
    var disablePercentUseMaxPont = is_percent_use_max_point == true ? "show" : "hide"
              ...
              <React.Fragment>
                ...
                <div class="form-group">
                  ...
                  <div class="form-check">
                    <input class="form-check-input" type="checkbox" checked={checkedAllow} name="allow_use_point_order" onChange={this.onChangeCheckBox} id="gridCheck33" />
                ...
                </div>
                {
                  ...
                  <>
                    <div class="form-group">
                      <div class="form-check">
                        <input class="form-check-input" checked={checkMaxPoint} name="is_set_order_max_point" onChange={this.onChangeCheckBox} type="checkbox" id="gridCheck22" />
                ...
                <div className="form-group">
                  ...
                  <div class="form-check">
                    <input class="form-check-input" type="checkbox" checked={bonus_point_product_to_agency} name="bonus_point_product_to_agency" onChange={this.onChangeCheckBox} id="gridCheck333" />
                  ...
                  {
                    bonus_point_product_to_agency && <div class="form-check">
                      <input class="form-check-input" type="checkbox" checked={bonus_point_bonus_product_to_agency} name="bonus_point_bonus_product_to_agency" onChange={this.onChangeCheckBox} id="gridCheck111" />
