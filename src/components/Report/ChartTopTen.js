...
class Chart extends Component {
  ...
  render() {
    ...
    if (typeof topten.total_items != "undefined") {
      var total_items = topten.total_items.length > 0 ? topten.total_items[0].total_items : 0
      var total_items_name = topten.total_items.length > 0 ? topten.total_items[0].product.name : ""
    }
    if (typeof topten.total_price != "undefined") {
      var total_price = topten.total_price.length > 0 ? topten.total_price[0].total_price : 0
      var total_price_name = topten.total_price.length > 0 ? topten.total_price[0].product.name : ""
    }
    ...
    return (
      ...
      <div className="chart">
        ...
        <div class="row">
          <div class="col-xl-3 col-lg-3" onClick = {() =>{this.onchangeTypeTop("THEO-DOANH-THU")}}>
            <div class="card card-stats mb-4 mb-xl-0">
              <div class="card-body">
                <div class="row">
                  <div class="col">
                    <h5 class="card-title card-size text-uppercase text-muted mb-0">Top tổng thu</h5>
                    <span class="h2  card-h2 font-weight-bold mb-0">{format(Number(total_price))}</span>
                  </div>
                  <div class="col-auto">
          ...
          <div class="col-xl-3 col-lg-3" onClick = {() =>{this.onchangeTypeTop("THEO-SO-LUONG")}}>
            <div class="card card-stats mb-4 mb-xl-0">
              <div class="card-body">
                <div class="row">
                  <div class="col">
                    <h5 class="card-title card-size text-uppercase text-muted mb-0">Top số lượng</h5>
                    <span class="h2 card-h2 font-weight-bold mb-0">{total_items}</span>
                  </div>
                  <div class="col-auto">
...

          {
            ...
            <div class="card card-stats mb-4 mb-xl-0">
              <div class="card-body">
                <div class="row">
                  <div class="col">
                    <h5 class="card-title card-size text-uppercase text-muted mb-0">Top số đơn</h5>
                    <span class="h2 card-h2 font-weight-bold mb-0">{number_of_orders}</span>
                  </div>
                  <div class="col-auto">
          ...
          {getChannel() == IKITECH &&           <div class="col-xl-3 col-lg-3" onClick = {() =>{this.onchangeTypeTop("THEO-LUOT-XEM")}}>
            <div class="card card-stats mb-4 mb-xl-0">
              <div class="card-body">
                <div class="row">
                  <div class="col">
                    <h5 class="card-title card-size text-uppercase text-muted mb-0">Top lượt xem</h5>
                    <span class="h2 card-h2 font-weight-bold mb-0">{view}</span>
                  </div>
                  <div class="col-auto">
