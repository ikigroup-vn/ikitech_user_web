...
class General extends Component {
    ...
    render() {
        var { store, store_code, collaborators , numDiscount , agencys , badges , customers} = this.props
        var total_collaborators = typeof collaborators != "undefined" ? collaborators.total : 0
                    ...
                    <div className="card border-left-danger shadow h-100 py-2">
                        <div className="card-body set-padding">
                            <div className="row no-gutters align-items-center">
                                <div className="col mr-2">
                                    <div >
                                        <Link className=" font-weight-bold text-danger text-uppercase mb-1" to={`/collaborator/${store_code}?tab-index=1`}>Cộng tác viên
                                        </Link>
                                    </div>
                    ...
                    <div className="card border-left-info shadow h-100 py-2">
                        <div className="card-body set-padding">
                            <div className="row no-gutters align-items-center">
                                <div className="col mr-2">
                                    <div >
                                        <Link className=" font-weight-bold text-info text-uppercase mb-1" to={`/agency/${store_code}?tab-index=1`}>Đại lý
                                        </Link>
                                    </div>
                                    <div className="h5 mb-0 font-weight-bold text-gray-800">{total_agencys ?? 0}</div>
                                </div>
                                <div className="col-auto">
                                    <i className="fas fa-users fa-2x text-gray-300"></i>
                                </div>
