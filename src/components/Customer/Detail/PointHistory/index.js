            ...
            result = listBills.map((bill, index) => {
                ...
                return (
                    <tr style={{ cursor: "pointer" }}>
                        <td>{index + 1}</td>
                        <td><Link to={`/order/detail/${store_code}/${bill.references_value}`} >{bill.references_value}</Link></td>

                        <td>
                            {formatNoD(bill.point)}
                        </td>
                        <td>
                            {bill.content}
                        </td>
            ...
            <div className="support">
                ...
                <form role="form" >
                    ...
                    <div class="box-body">
                        ...
                        <label htmlFor="name">Xu hiện tại:&nbsp;{customer.points > 0 ? formatNoD(customer.points || 0) : 0}</label>
