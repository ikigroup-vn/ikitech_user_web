...
class ModalDetail extends Component {
    ...
    handleCallback = () => {
        ...
        if (info.distributeProduct.length === 0) {
            if (this.props.modal.inventoryProduct.main_stock <= 0) {
                this.setState({ messageErr: `Sản phẩm đã hết hàng không thể chuyển kho` })
                return
            }
            ...
            this.props.handleCallbackPushProduct({
                ...
                reality_exist: this.props.modal.inventoryProduct.main_stock ?? 1, nameDistribute: distributeName,
        ...
        if (info.distributeProduct[0].element_distributes[0].sub_element_distributes.length === 0) {
            ...
            this.props.handleCallbackPushProduct({
                ...
                reality_exist: quantityInStock ?? 1, nameDistribute: distributeName,
                nameElement: distributeValue,
                nameSubDistribute: element_distributes,
