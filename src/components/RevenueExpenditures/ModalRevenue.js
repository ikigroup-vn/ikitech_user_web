...
class ModalRevenue extends Component {
    ...
    if (change_money == null || !isEmpty(change_money)) {
      this.props.showError({
        ...
        alert: {
          ...
          title: "Lỗi",
          disable: "show",
          content: "Giá trị thu không được để trống",
        },
      });
      return;
    }
    ...
    if (type === null || typeof type === undefined) {
      this.props.showError({
        ...
        alert: {
          ...
          title: "Lỗi",
          disable: "show",
          content: "Loại phiếu thu không được để trống",
        },
      });
      return;
    }
  ...
  render() {
    ...
    console.log(recipient_group, recipient_references_id, listRecipientGroup);
    return (
      <div
        class="modal fade"
        tabindex="-1"
