...
class Form extends Component {
  ...
  goToBack = () => {
    ...
    if (
      moment(this.state.weekNowFrom_prime.from, "DD-MM-YYYY").isAfter(
        moment(beforeWeek_prime.from, "DD-MM-YYYY")
      )
    ) {
      beforeWeek_prime = {
      ...
      <div className={isWeek}>
        ...
        <div className="prime">
          ...
          <div className="navigation-buttons">
            {!moment(this.state.weekNowFrom_prime.from, "DD-MM-YYYY").isSame(
