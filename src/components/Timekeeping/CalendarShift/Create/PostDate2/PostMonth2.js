...
class Form extends Component {
  ...
  goToBack = () => {
    ...
    if (
      moment(this.state.monthNowFrom_prime.from, "DD-MM-YYYY").isAfter(
        moment(beforeMonth_prime.from, "DD-MM-YYYY")
      )
    ) {
      beforeMonth_prime = {
        from: moment().format("DD-MM-YYYY"),
      ...
      <div className={isMonth}>
        ...
        <div className="prime">
          ...
          <div className="navigation-buttons">
            {!moment(this.state.monthNowFrom_prime.from, "DD-MM-YYYY").isSame(
