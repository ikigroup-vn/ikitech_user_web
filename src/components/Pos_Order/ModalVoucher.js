                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div className='model-header-modal' style={{display:'flex',justifyContent:"space-between", margin:"10px 15px"}}>
                            <p class="" style={{margin:"0px",fontWeight:"bold"}}>Ví Voucher</p>
                    ...
                    <div class="form-group" style={{padding:"5px",display:"flex",justifyContent:"space-between"}}>
                                    ...
                                    />
                            <button class="btn btn-info" onClick={() =>this.handleChooseVoucher()} data-dismiss="modal" style={{backgroundColor: themeData().backgroundColor}}>Áp dụng</button>
                                </div>
                        {listVoucher.map((item,index) =>(
                            <div className='model-card row' key={index} style={{borderRadios:"0.25em",border:"dashed 2px red",position:"relative",margin:"5px"}}>
                            <button class="btn btn-info" onClick={() =>this.handleOnclicks(item.code)} data-dismiss="modal" style={{backgroundColor: themeData().backgroundColor,position:"absolute", right:"3px", top:"3px",zIndex:"100"}}>Áp dụng</button>
                            <div className='name-voucher col-3' style={{width:"120px",height:"120px",padding:"8px"}}>
                                <div style={{backgroundColor: themeData().backgroundColor,color:"white",justifyContent:"center",width:"100%",height:"100%",borderRadius:"0.25em",display:"flex",alignItems:"center",flexDirection:"column"}}>
                            ...
                            <div className='info-voucher col-9' style={{display:"flex",flexDirection:"column",justifyContent:"space-around"}}>
                                    <div>
                                    <div className='name' style={{fontWeight:"bold"}}><span>{item.name}</span></div>
