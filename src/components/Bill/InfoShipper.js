...
class InfoShipper extends Component {
  ...
  setShowModalShipAddress = (showModal) => {
    ...
    this.props.fetchAllShipAddress(
    ...
    this.setState({ showModalShipAddress: showModal });
  };
  setCloseModalShipAddress = (showModal) => {
    this.setState({ showModalShipAddress: showModal });
  };
  ...
  cancelShipments = () => {
    ...
    this.props.cancelShipment(store_code, bill?.shipment?.from_shipper_code);
  };
  render() {
    var { bill, historyDeliveryStatus, order_code, store_code } = this.props;
    const { packet, isUpdated, shipmentInfo, showModalShipAddress } =
      this.state;
          ...
          <InfoShipperStyles>
                      ...
                      <>
                        <div className="delivery-cart">
                          ...
                          <div className="content-delivery-cart-child">
                            {shipmentInfo.data?.fee_with_type_ship?.length >
                              0 &&
                        ...
                        >
                          <button
                            ...
                            style={{
                              marginRight: "10px",
                              opacity:
                                shipmentInfo.shipment_selected === null
                                  ? 0.7
                                  : 1,
                            }}
                          >
                  ...
                  <div style={{ textAlign: "center" }}>
                    <div class="m-3">
                      {bill?.shipment?.from_shipper_code ? (
                        ...
                        <button
                          type="button"
                          onClick={() => this.setShowModalShipAddress(true)}
                          className="btn btn-primary  btn-sm"
                          style={{
                            marginRight: "10px",
                            opacity:
            ...
            {!showModalShipAddress ? null : (
              <ModalShipAddress
                ...
                setCloseModalShipAddress={this.setCloseModalShipAddress}
              ></ModalShipAddress>
            )}
            <ModalCancelDelivery
...
const mapDispatchToProps = (dispatch, props) => {
  return {
    ...
    cancelShipment: (store_code, order_code, order_codes) => {
      dispatch(
        shipmentAction.cancelShipment(store_code, order_code, order_codes)
      );
    },
