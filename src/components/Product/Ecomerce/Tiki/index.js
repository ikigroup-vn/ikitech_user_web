...
class Tiki extends Component {
  ...
  fetchAllProductEcommerce = () => {
    ...
    this.props.fetchAllProductEcommerce(store_code, 1, { shop_id, provider: "tiki" })
  }
  ...
  fetchAllProductEcommercePage = (page) => {
    ...
    this.props.fetchAllProductEcommerce(store_code, page, { shop_id: shop_id_page, provider: "tiki" })
        ...
        <div class="modal-dialog modal-lg" role="document">
          <div class="modal-content" style={{ maxHeight: "630px" }}>
            <div class="modal-header" style={{ background: "white" }}>
              <h4 class="modal-title" style={{ color: "#0b1b66" }}>Lấy sản phẩm từ sàn TMĐT Tiki</h4>
            ...
            <div class="modal-body">
              ...
              <div class="form-group">
                <div class="alert alert-info alert-dismissible" role="alert">
                  Các sản phẩm từ cửa hàng trên sàn TMĐT Tiki sẽ được tải về
                </div>

              </div>
              <div className="form-group">
                <label htmlFor="lname">Nhập mã cửa hàng Tiki</label>
                <div
                ...
                >
                  <input
                    ...
                    class="form-control"
                    placeholder="Nhập mã cửa hàng Tiki tại đây"
                  />
...
const mapStateToProps = (state) => {
  return {
    products: state.productReducers.product.allProductTiki,
...
export default connect(mapStateToProps, mapDispatchToProps)(Tiki);
