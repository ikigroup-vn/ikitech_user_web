...
class ModalUpload extends Component {
  ...
  onSave = async (e) => {
    ...
    var { ImgProduct, listImgProduct, imgs } = { ...this.props };
    console.log("dfsdafasdfs", ImgProduct, listImgProduct, imgs);
    ...
    if (typeof file !== "undefined" && file != "" && file != null) {
      ...
      console.log(fd, ImgProduct, listImgProduct);
      this.props.uploadListImgProduct(fd, ImgProduct, listImgProduct);
...
const mapDispatchToProps = (dispatch, props) => {
  return {
    uploadListImgProduct: (file, ImgProduct, listImgProduct) => {
      dispatch(
        productAction.uploadListImgProduct(file, ImgProduct, listImgProduct)
      );
    },
    checkNumImg: (alert) => {
      dispatch(alert);
