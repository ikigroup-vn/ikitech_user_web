...
class Footer extends Component {
    ...
    onSave = (e) => {
        ...
        form.contact_individual_organization_name = theme.contact_individual_organization_name
                ...
                <form role="form" onSubmit={this.onSave} >
                    ...
                    <div class="box-body">
                        ...
                        <div className="form-group">
                            ...
                            <textarea value={contact_address}
                                onChange={this.onChange}
                                name="contact_address" id="input" class="form-control" rows="4" required="required"></textarea>

                        </div>
                        <div className="form-group">
                            <label htmlFor="name">Địa chỉ Email</label>
                            <input type="email" name="contact_email" value={contact_email} placeholder="Nhập..." onChange={this.onChange} className="form-control" id="txtName" autoComplete="off" />

                        </div>
                        <div className="form-group">
                            <label htmlFor="name">Số điện thoại</label>
                            <input type="tel" name="contact_phone_number" value={contact_phone_number} placeholder="Nhập..." onChange={this.onChange} className="form-control" id="txtName" autoComplete="off" />

                        </div>
                        <div className="form-group">
                            <label htmlFor="name">Thời gian làm việc</label>
                            <input type="text" name="contact_time_work" value={contact_time_work} placeholder="Nhập..." onChange={this.onChange} className="form-control" id="txtName" autoComplete="off" />
