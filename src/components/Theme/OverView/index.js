...
class Overview extends Component {
  ...
  onSave = (e) => {
    ...
    // form.logo_delivery = theme.logo_delivery;
      ...
      <div className="overview">
        ...
        <form role="form" onSubmit={this.onSave}>
          <div class="box-body">
              ...
              <div class="row" style={{ justifyContent: "space-between" }}>
                ...
                <div class="form-group col-xs-4 col-lg-4 col-md-6 col-sm-6">
                  ...
                  <div class="kv-avatar">
                    <div>
                      <button
                        onClick={() => this.onChangeUpload("DELIVERY")}
                        type="button"
                        class="btn btn-primary-no-background btn-sm"
                        // style={{ marginLeft: "10px" }}
                        data-toggle="modal"
            ...
            <div className="form-group">
              <label htmlFor="name">Title giao hàng</label>
              <input
                type="text"
                className="form-control"
                placeholder="Tiêu để giao hàng của bạn"
                id="txtName"
                onChange={this.onChange}
                value={delivery || ""}
                name="delivery"
