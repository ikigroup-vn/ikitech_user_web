...
class Home_Screen extends Component {
    constructor(props) {
        ...
        this.initTheme = [
            {
                index: 1,
                theme: "https://data1.doapp.vn/public/api/SahaImages/gNdPimsxMW1635935514.png"
            },
            {
                index: 2,
                theme: "https://data1.doapp.vn/public/api/SahaImages/bgbHigFfFE1635128355.png"
            },
            {
                index: 3,
                theme: "https://data1.doapp.vn/public/api/SahaImages/LZXepjhaEf1635387768.png"
            },

            {
                index: 4,
                theme: "https://data1.doapp.vn/public/api/SahaImages/NrWkHISXeg1635562805.png"
            },
            {
                isVip : true,
                index : 5,
                theme : "https://data1.doapp.vn/public/api/SahaImages/SVLdjoSfmN1637398732.jpg"
            },
            {
                isVip : true,
                index : 6,
                        ...
                        <div>
                            <div class="row">
                                           ...
                                           {this.initTheme.map((v, i) => (
                                                <ItemTheme badges = {badges} chooseTheme = {this.chooseTheme}  home_page_type = {home_page_type}  v = {v} />
                                        ))}
