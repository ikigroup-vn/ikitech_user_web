    ...
    this.initTheme = [
      {
        ...
        banner_type:"Banner ngắn",
        banner_height:"426px",
        banner_width: "743px",
        description:"Giao diện giúp cho cửa hàng có thể dễ dàng bán các sản phẩm điện tử cho chính mình",
      ...
      },
      {
        ...
        banner_height:"410px",
        banner_width: "915px",
        description:"Giao diện được thiết kế phù hợp trẻ trung, tươi mới phù hợp với bán các sản phẩm cho bé"
      },
      {
        index: 3,
        theme:
        ...
        banner_type:"Banner dài",
        banner_height:"1530px",
        banner_width: "580px",
        description:"Giao diện được thiết kế phù hợp với bán các sản phẩm nội thát",
      ...
      },
      {
        ...
        banner_width: "475px",
        description:"Giao diện được thiết kế trẻ trung, phong cách phù với bán các sản phẩm mỹ phẩm, thời trang",
      ...
      },
      {
        ...
        banner_height:"412px",
        banner_width: "1170px",
        description:"Giao diện được thiết kế với gam màu rực rỡ phù hợp với bán các sản phẩm đồ ăn, hoa quả",
      ...
      },
      {
        ...
        banner_height:"410px",
        banner_width: "685px",
        description:"Giao diện được thiết kết phù hợp với các sản phẩm đồ gia dụng, đồ điện tử",
      ...
      },
      {
        ...
        banner_height:"1481px",
        banner_width: "440px",
        description:"Giao diện được thiết kế phù hợp với bán các mặt hàng đồ ăn, hoa quả",
        carrers:"Đồ ăn, hoa quả"
      },
      {
        isVip: false,
        ...
        banner_height:"355px",
        banner_width: "702px",
        description:"Giao diện phù hợp với bán các sản phẩm liên quan đến đồ ăn, hoa quả",
        carrers:"Đồ ăn, hoa quả"
      },
      {
        isVip: false,
        index: 10,
        theme: "https://www.cgv.vn/media/catalog/product/cache/1/image/c5f0a1eff4c394a251036189ccddaacd/p/o/poster_adam_4_1.jpg",
