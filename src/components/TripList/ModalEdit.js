  ...
  return (
    ...
    >
      {({
        ...
        // Hiển thị giá trị đã chọn, hoặc searchValue nếu đang gõ
              ...
              <input
                {...getInputProps({
                  ...
                  onChange: (e) => {
                    ...
                    setIsTyping(true); // Đánh dấu đang gõ
                  },
                  onKeyDown: (e) => {
                    // Khi bắt đầu gõ, bật chế độ typing
                    if (e.key.length === 1) {
                      setIsTyping(true);
                    }
                  },
