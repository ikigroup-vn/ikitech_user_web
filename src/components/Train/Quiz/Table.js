...
class Table extends Component {
  ...
  passEditFunc = (e, id, title, short_description,auto_change_order_questions,auto_change_order_answer , minute) => {
    this.props.handleUpdateCallBack({
        id: id,
        title: title,
        short_description: short_description,
        auto_change_order_questions,auto_change_order_answer , minute
    });
    e.preventDefault();
};
              ...
              <button
                ...
                onClick={(e) =>
                  this.passEditFunc(
                    ...
                    data.auto_change_order_questions,data.auto_change_order_answer , data.minute
                  )
                }
                data-toggle="modal"
                data-target="#updateQuizModal" class={`btn btn-warning btn-sm`}
              >
