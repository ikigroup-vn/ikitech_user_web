      ...
      >
        ...
        >
          ...
          <div className="sidebar-brand-text">
            ...
            <img width = "80%" src={badges?.config_user_vip?.url_logo_image != null ? badges?.config_user_vip?.url_logo_image : "/images/logoikitech-do.jpg"}  class="img-responsive" alt="Image"/>
