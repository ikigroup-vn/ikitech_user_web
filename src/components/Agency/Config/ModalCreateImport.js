...
class ModalCreateImport extends Component {
  constructor(props) {
    super(props);
    this.state = {
      txtLimit: "",
...
const mapDispatchToProps = (dispatch, props) => {
  return {
    createStep: (id, form) => {
      dispatch(agencyAction.createStepImport(id, form));
    },
  };
};
export default connect(null, mapDispatchToProps)(ModalCreateImport);
