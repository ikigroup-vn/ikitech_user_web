...
class Chart extends Component {
    ...
    onchangeDateFromTo = (e) => {
        ...
        this.props.fetchOverview(store_code, `?date_from=${from}&date_to=${to}&agency_by_customer_id=${agency_by_customer_id}`);
    };
    fromPrime = () => {
        this.setState({
            typeChartShow: "PRIME"
    ...
    render() {
        ...
        return (
            <div className="chart">
                <ModalPostDate agency_by_customer_id={this.props.agency_by_customer_id} reset={reset} handleGetDatePost={this.handleGetDatePost} store_code={store_code} typeDate={typeDate} />
            ...
            /> */}
                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-6" onClick={() => { this.actionChart("total_final") }}>
                    ...
                    <div class="col-xl-6 col-lg-6" onClick={() => { this.actionChart("total_order_count") }}>
                        <div class="card card-stats mb-4 mb-xl-0">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col">
